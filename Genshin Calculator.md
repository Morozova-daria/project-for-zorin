...
2. **Выбирает роль:** "Саппорт стихии Дендро"
...
3. **Показывает,** какие подземелья фармить для улучшения
...
** Вместо:** Успешный ввод характеристик  
** Проблема:** Пользователь неправильно ввел статы артефакта
** Решение:**
1. **Система проверяет** введенные значения на валидность
2. **Обнаруживает,** что критический шанс стоит на шапке с мейн статом критический шанс (не возможны 2 одинаковые характеристики на одном артефакте)
3. **Показывает сообщение:** "Критический шанс уже есть с главном стате"
4. **Подсвечивает** поле с ошибкой красным
5. **Предлагает исправить** на другой стат
...
** Пользователь:** Денис, хочет выбрать между двумя сетами
